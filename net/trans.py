...
from net.bck import Unet, DeUp_Cat, DeBlock, BiFusion_block
...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        self.bif = BiFusion_block(ch_1=256, ch_2=256, r_2=16, ch_int=256, ch_out=256)
        #         self.bif = Residual(inp_dim=256, out_dim=128)

        self.DeUp5 = DeUp_Cat(in_channels=256, out_channels=128)
        self.DeBlock5 = DeBlock(in_channels=128)
    ...
    def forward(self, x_in):
        x1_1, x2_1, x3_1, x4_1, x5_1 = self.Unet(x_in)
        ...
        fuse = self.bif(x5_1, dec3)
        # print("dec3", dec3.size())
        y5 = self.DeUp5(fuse, x4_1)  # (1, 128, 16, 16, 16)
        y5 = self.DeBlock5(y5)
