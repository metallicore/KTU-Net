...
class Unet(nn.Module):
    def __init__(self, in_channels=4, base_channels=16, num_classes=4):
        ...
        self.cbam1 = FEB(in_channels=base_channels)
        self.cbam2 = FEB(in_channels=base_channels * 2)
        self.cbam3 = FEB(in_channels=base_channels * 4)

    def forward(self, x):
        x = self.InitConv(x)  # (1, 16, 128, 128, 128)

        x1_1 = self.EnBlock1(x)  # (1, 16, 128, 128, 128)
        z1 = self.cbam1(x1_1)
...
if __name__ == '__main__':
    ...
    z1, z2, z3, x1_1, x2_1, x3_1, output = model(x)
    print('z1:', z1.shape)
    print('z2:', z2.shape)
    print('z3:', z3.shape)
